import { Box, Button, Container, Divider, Grid, IconButton, InputAdornment, InputLabel, Stack, Typography } from "@mui/material";
          ...
          <Grid container spacing={6} mb="48px" mt="48px">
                  ...
                  (item, index) => {
                    return (
                      <Box>
                        ...
                        >
                          <Typography sx={{mr:"15px",fontSize:"1.5rem"}}>{item.icon}</Typography>
            ...
            <Grid item xs={12} xl={9} >
              <Box>
                {activeCard === 1 ? (
                  ...
                  <ProfileCard sx={{width:"88%"}}>
                    ...
                    <Stack direction="row" justifyContent="space-between">
                      ...
                      <Box>
                        <img src={EditIcon} style={{cursor:"pointer"}} onClick={() => setEditAcc((oldValue) => !oldValue)}/>
                      </Box>
                  ...
                  <ProfileCard sx={{width:"88%",mt:"40px"}}>
                    ...
                    >
                      ...
                      <Box sx={{ textAlign: "start",mt:"31px" ,gap:"14px",display:"flex"}}>
                        <OutlineButton
                ...
                {activeCard === 2 && <AddressSection  activeCard={activeCard} setActiveCard={setActiveCard}/>}
                {activeCard === 3 && (
                  <ProfileCard>
                      ...
                      <Box mb="20px" mt="24px">
                        <Box sx={{ position: "relative" }}>
                          ...
                          <VisibilityOffIcon
                            ...
                            onClick={() => setShowNewPass(oldValue => !oldValue)}
                          />
                        </Box>
                      </Box>
                      <Box mb="20px" mt="24px">
                ...
                {activeCard===4&&
                <ProfileCard sx={{width:"90%"}}>
                <AddressSave activeCard={activeCard} setActiveCard={setActiveCard} />
        </ProfileCard>   }
              </Box>
            </Grid>
          </Grid>
